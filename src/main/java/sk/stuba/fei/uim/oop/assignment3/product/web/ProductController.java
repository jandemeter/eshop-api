...
public class ProductController {
    ...
    public ProductResponse updateProduct(@PathVariable("id") Long productId, @RequestBody ProductUpdateRequest update) throws NotFoundException {
        return new ProductResponse(this.service.update(productId, update));
    }
    ...
    public Amount addAmount(@PathVariable("id") Long productId, @RequestBody Amount add) throws NotFoundException {
        return new Amount(this.service.addProductAmount(productId, add.getAmount()));
    }
}
